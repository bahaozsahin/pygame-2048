...
import random
from Constants.colors import c
...
class Game(tk.Frame):
    ...
    def start_game(self):
        ...
        #create a matrix of 0s DONE
        self.matrix = [[0] * 4 for _ in range(4)]

        #then fill random 2 tiles with 2s DONE
    ...
    #Define matrix manipulation functions
    ...
    #Add new tiles as 2 or 4 tiles DONE
    ...
    def add_new_tile(self):
        ...
        while(self.matrix[row][col] != 0):
            row = random.randint(0,3)
            col = random.randint(0,3)
        # Select randomly from an array of 2 and 4
    ...
    def game_over(self):
        ...
        if any(2048 in row for row in self.matrix):
            ...
            tk.Label(
                game_over_frame,
                text = "Congratulations, You achieved 2048",
                bg=c.WINNER_BG,
